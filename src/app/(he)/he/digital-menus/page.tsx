...
export default function HeDigitalMenusPage() {
  const content = createElement(
    ...
    createElement("img", { src: "/images/ai/ezorders-mobile-ordering-app.webp", width: 1024, height: 1024, alt: "תפריט דיגיטלי למסעדה על מסך טלפון — אפליקציית EZOrders ליד מעמד QR על שולחן", style: imgStyle, loading: "lazy" }),
    ...
    createElement("h3", { style: h3Style }, "עיצוב ייחודי למותג שלכם"),
    createElement("p", { style: bodyStyle }, "התפריט נראה כמו המסעדה שלכם ולא כמו תבנית גנרית — צבעים, לוגו וסגנון תמונות משלכם. סועד שמזהה את המותג כבר במסך הראשון ניגש להזמנה בביטחון גדול יותר."),
    createElement("h3", { style: h3Style }, "ניהול מלוח בקרה אחד"),
    createElement("p", { style: bodyStyle }, "כל התפריטים, הסניפים והמחירים יושבים במקום אחד. אין צורך לזכור איפה משנים מה — עדכון נעשה פעם אחת ומתעדכן בכל הערוצים שבהם התפריט מופיע."),
    createElement("h3", { style: h3Style }, "דוחות שמראים מה באמת נמכר"),
    createElement("p", { style: bodyStyle }, "ראו אילו מנות נבחרות שוב ושוב, אילו נתקעות ואיפה הסועדים נוטשים באמצע. במקום לנחש מה לקדם ומה להוריד מהתפריט, אתם מחליטים לפי נתונים מהתפריט עצמו."),
