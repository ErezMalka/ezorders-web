...
export const kioskStandsContent: ProductContent = {
  ...
  benefits: [
    { title: "More Accurate Orders", body: "Required vs. optional modifiers, allergen icons, and clear culinary notes reduce order mistakes and costly re-fires. Orders route directly to printers with item-level detail, so the kitchen knows exactly what to make-and in what sequence." },
    { title: "Lower labor costs", body: "By shifting routine ordering to kiosks, you can schedule leaner front-of-house shifts and reassign team members to prep and hospitality." },
    { title: "Better accessibility, broader reach", body: "Multilingual flows let guests choose their preferred language right at the kiosk—so no staff member needs to speak it—making ordering easier for more people and expanding your audience without extra staffing." },
  ],
  faq: [
