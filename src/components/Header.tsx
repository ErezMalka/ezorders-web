...
import { nav as defaultNav, SIGNUP_URL } from "@/data/content";
...
export function Header({ dictionary }: { dictionary?: Dictionary }) {
  ...
  const navItems: readonly NavEntry[] = dictionary?.nav ?? defaultNav;
    const ctaLabel = dictionary?.header.cta ?? "Try Free for 14 Days";
